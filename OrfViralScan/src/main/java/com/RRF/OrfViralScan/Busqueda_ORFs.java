...
public class Busqueda_ORFs {
    ...
    public static boolean normalizacionGlobal;
    
    public static String global1Temporal;
    public static String global2Temporal;
    
    public static void cargarBusquedaORFs(String entrada, String salida, int orientacion) {
		
        try{
        
            normalizacionGlobal = true;
            global1Temporal = "";
            global2Temporal = "";
    ...
    public static void Identificador_Secuencias_Nucleotidos(char cadena[], String sec_Nucl[], int marco,
        ...
        try{
            ...
            for(int i = 0; i<sec_Nucl.length; i++){
                ...
                if(normalizacionGlobal == true){
                
                    StringBuilder tempBuilder1 = new StringBuilder(cadena1Global.length());
                    ...
                    for(int recorrerGlobal = 0; recorrerGlobal < cadena1Global.length(); recorrerGlobal++){
                        ...
                        char charActual1 = cadena1Global.charAt(recorrerGlobal);
                        
                        if(charActual1 != 'A' && charActual1 != 'C' && 
                           charActual1 != 'T' && charActual1 != 'G'){
                            
                            tempBuilder1.append('?');
                            
                        } else {
                            
                            tempBuilder1.append(charActual1);
                            
                        }
                        
                    }
                    
                    global1Temporal = tempBuilder1.toString();

                    StringBuilder tempBuilder2 = new StringBuilder(cadena2Global.length());
                    
                    for(int recorrerGlobal = 0; recorrerGlobal < cadena2Global.length(); recorrerGlobal++){
                        ...
                        char charActual2 = cadena2Global.charAt(recorrerGlobal);
                        
                        if(charActual2 != 'A' && charActual2 != 'C' && 
                           charActual2 != 'T' && charActual2 != 'G'){
                            
                            tempBuilder2.append('?');
                            
                        } else {
                            
                            tempBuilder2.append(charActual2);
                            
                        }
                    }
                    
                    global2Temporal = tempBuilder2.toString();
                
                    normalizacionGlobal = false;
